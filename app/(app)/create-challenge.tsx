...
export default function CreateChallengeScreen() {
  ...
  const handleCreateChallenge = async () => {
    if (!name || !targetSteps || !duration || !user) {
    ...
    createChallengeMutation.mutate({
      name,
      type: isDailyAverage ? 'daily_average_goal' : 'total_steps_goal',
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={[styles.infoCard, { backgroundColor: theme.colors.card }]}>
          ...
          <Text style={[styles.infoText, { color: theme.colors.textSecondary }]}>
            {isDailyAverage 
              ? `Participants will aim to average ${parseInt(targetSteps || '0').toLocaleString()} steps per day over ${duration} days.`
              : `Participants will aim to reach a total of ${(parseInt(targetSteps || '0') * parseInt(duration || '1')).toLocaleString()} steps over ${duration} days.`
            }
          </Text>
        </View>
        ...
        <TouchableOpacity
          style={[
            ...
            createChallengeMutation.isPending && styles.disabledButton
          ]}
