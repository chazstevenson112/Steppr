...
export default function AddActivityModal() {
  ...
  const handleAddActivity = async () => {
    if (!selectedActivity || !quantity || !user) {
    ...
    if (!selectedActivityDetails) return;

    createActivityMutation.mutate({
      type: selectedActivity as any,
      quantity: parseFloat(quantity),
      unit: selectedActivityDetails.unit as any,
      userId: user.uid,
    });
  };
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <TouchableOpacity
          style={[
            ...
            (!selectedActivity || !quantity || createActivityMutation.isPending) && styles.disabledButton
          ]}
          onPress={handleAddActivity}
          disabled={!selectedActivity || !quantity || createActivityMutation.isPending}
        >
